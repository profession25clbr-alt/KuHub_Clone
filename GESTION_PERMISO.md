...
| Flag               | Significado                                    |
|--------------------|------------------------------------------------|
| `puede_leer`       | Permite visualizar información (GET)           |
| `puede_crear`      | Permite crear registros (POST)                 |
| `puede_actualizar` | Permite modificar registros (PUT/PATCH)        |
| `puede_eliminar`   | Permite eliminar registros (DELETE)            |
