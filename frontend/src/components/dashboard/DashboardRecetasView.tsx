...
import { getDashboardRecetas, DashboardRecetasData } from '../../services/api-dashboard';
...
export const DashboardRecetasView: React.FC = () => {
  const [data, setData] = React.useState<DashboardRecetasData | null>(null);
  ...
  if (error || !data) {
    return (
      <div className="text-center py-20 text-default-400">
        Error al cargar los datos del dashboard de recetas.
      </div>
    );
  }
        ...
        <Card className="shadow-sm border border-divider bg-[#FFB800]/5">
          <CardBody className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-default-400 uppercase tracking-wider">Ingrediente más usado en recetas activas</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="shadow-sm border border-divider">
          <CardHeader className="pb-0 pt-4 px-5">
            <h3 className="text-sm font-semibold text-default-700">Estado de Recetas</h3>
          </CardHeader>
          <CardBody className="p-4">
            {pieData.length === 0 ? (
        ...
        <Card className="shadow-sm border border-divider">
          <CardHeader className="pb-0 pt-4 px-5">
            <h3 className="text-sm font-semibold text-default-700">Top 10 Ingredientes en Recetas Activas</h3>
          </CardHeader>
          <CardBody className="p-4">
