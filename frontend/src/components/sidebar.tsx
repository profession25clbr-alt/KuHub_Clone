      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-5 flex items-center justify-between border-b border-default-100 dark:border-default-50">
          <div className="flex items-center">
            {/* Logo de KüHub */}
            <div className="w-[72px] h-[72px] flex items-center justify-center rounded-lg shadow-sm overflow-hidden">
              <img src={LOGO_URL} alt="Logo KüHub" className="w-full h-full object-cover scale-125" />
            </div>
            <motion.div
